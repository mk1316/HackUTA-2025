            ...
            <div className="flex items-center space-x-3">
              ...
              {!audioUrl && (
                <button
                  ...
                  className="inline-flex items-center px-3 py-1 text-sm font-medium text-purple-700 bg-purple-100 dark:bg-purple-900/20 dark:text-purple-400 rounded-md hover:bg-purple-200 dark:hover:bg-purple-900/30 disabled:opacity-50"
                >
